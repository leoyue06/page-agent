...
export class PageController extends EventTarget {
	...
	async getBrowserState(): Promise<BrowserState> {
		...
		// KNOVA: stamp the running build into every snapshot. We burned two rounds unable to tell
		...
		const titleLine = `Current Page: [${title}](${url})  [knova-build:v13-revive-serialized]`
